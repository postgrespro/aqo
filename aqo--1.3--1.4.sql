...
ALTER TABLE aqo_data ADD COLUMN reliability double precision [];

DROP FUNCTION top_error_queries(int);
...
--
CREATE OR REPLACE FUNCTION show_cardinality_errors(controlled boolean)
...
COMMENT ON FUNCTION show_cardinality_errors(boolean) IS
